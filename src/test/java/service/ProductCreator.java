...
public class ProductCreator {
    ...
    /*public static Product productForCart(){
        return new Product(TestDataReader.getTestData(TESTDATA_TO_CART_PRODUCT_NAME),TestDataReader.getTestData(TESTDATA_TO_CART_PRODUCT_PRICE),
                TestDataReader.getTestData(TESTDATA_TO_CART_PRODUCT_URL));
    }*/
