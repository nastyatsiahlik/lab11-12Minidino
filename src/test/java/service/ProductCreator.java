...
public class ProductCreator {
   ...
   // public static  String TESTDATA_TO_CART_PRODUCT_PRICE = "1890";
    ...
    public static Product productForCart(){
        return new Product(TestDataReader.getTestData(TESTDATA_TO_CART_PRODUCT_NAME), TestDataReader.getTestData(TESTDATA_TO_CART_PRODUCT_PRICE), TESTDATA_TO_CART_PRODUCT_URL);
    }
